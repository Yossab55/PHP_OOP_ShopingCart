...
echo $cart->getTotalQuantity(). "<br>"; // This must print 2
echo "Total price of items in cart: ". "<br>";
echo $cart->getTotalSum(). "<br>"; // This must print 2900

$cartItem2->increaseQuantity();
$cartItem2->increaseQuantity();
echo "Number of items in cart: ". "<br>";
echo $cart->getTotalQuantity(). "<br>"; // This must print 4

echo "Total price of items in cart: ". "<br>";
echo $cart->getTotalSum(). "<br>"; // This must print 3700

$cart->removeProduct($product1);

echo "Number of items in cart: ". "<br>";
echo $cart->getTotalQuantity(). "<br>"; // This must print 3

echo "Total price of items in cart: ". "<br>";
echo $cart->getTotalSum(). "<br>"; // This must print 1200
